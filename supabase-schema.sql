...
CREATE TABLE IF NOT EXISTS "Exercise" (
    ...
    "videoUrl" TEXT,
    "thumbnailUrl" TEXT,
    "videoSource" TEXT NOT NULL DEFAULT 'Kaggle: hasyimabdillah/workoutfitness-video',
    "verificationStatus" TEXT NOT NULL DEFAULT 'verified',
    "videoVerified" BOOLEAN NOT NULL DEFAULT TRUE,
    "metadataVerified" BOOLEAN NOT NULL DEFAULT TRUE,
    "sourceVerified" BOOLEAN NOT NULL DEFAULT TRUE,
    "lastVerified" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT NOW(),
    "aiVideoUrl" TEXT,
    "aiVideoStatus" TEXT DEFAULT 'pending',
    "aiVideoVerified" BOOLEAN NOT NULL DEFAULT FALSE,
